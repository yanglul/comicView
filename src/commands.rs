...
pub async fn get_scramble_id(jm_client: State<'_, JmClient>, id: i64) -> Result<i64> {
...
pub fn show_path_in_file_manager(path: &str) -> Result<()> {
...
pub async fn sync_favorite_folder(jm_client: State<'_, JmClient>) -> Result<()> {
    // 同步收藏夹的方式是随便收藏一个漫画
