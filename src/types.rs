...
impl Comic {
    ...
    pub fn from_comic_resp_data( app: &MyApp,comic: GetComicRespData) -> Self {
    ...
    fn get_is_downloaded(app: &MyApp, comic_title: &str, chapter_title: &str) -> bool {
...
impl SearchResult {
    pub fn from_search_resp(app: &MyApp, search_resp: SearchResp) -> Self {
        match search_resp {
